...
if __name__ == '__main__':
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C59ROM1.txt', 'rb') as file:
        lines = file.readlines()
    with open(Path(__file__).parent / 'CDATA' / 'C59ROM2.txt', 'rb') as file:
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C59ROM0.txt', 'rb') as file:
        lines = file.readlines()
    ...
    for i, line in enumerate(lines):
        ...
        except UnicodeDecodeError: # Helper to detect decoding issues
            linestr = line.decode('cp932', errors='backslashreplace')
            cols = linestr.split('\t')
            print(linestr)
            print(line)
