...
if __name__ == '__main__':
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C65ROM1.txt', 'rb') as file:
        lines = file.readlines()
    with open(Path(__file__).parent / 'CDATA' / 'C65ROM2.txt', 'rb') as file:
        lines.extend(file.readlines())
    with open(Path(__file__).parent / 'CDATA' / 'C65ROM3.txt', 'rb') as file:
        lines.extend(file.readlines())
    ...
    for raw_entry in raw_entries:
        ...
        circles_raw.append(Circle(
            ...
            media=[
                Medium(f"{NUM}_{page}.jpg", # TODO: to host
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C65ROM0.txt', 'rb') as file:
        lines = file.readlines()
