...
if __name__ == '__main__':
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C66ROM1.txt', 'rb') as file:
        lines = file.readlines()
    with open(Path(__file__).parent / 'CDATA' / 'C66ROM2.txt', 'rb') as file:
        lines.extend(file.readlines())
    with open(Path(__file__).parent / 'CDATA' / 'C66ROM3.txt', 'rb') as file:
        lines.extend(file.readlines())
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C66ROM0.txt', 'rb') as file:
        lines = file.readlines()
