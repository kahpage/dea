...
if __name__ == '__main__':
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C67ROM1.txt', 'rb') as file:
        lines = file.readlines()
    with open(Path(__file__).parent / 'CDATA' / 'C67ROM2.txt', 'rb') as file:
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C67ROM0.txt', 'rb') as file:
        lines = file.readlines()
