...
GENRES: dict[int, str] = {
    ...
    900: "その他",
    999: "ノンジャンル",
    201: "UNKNOWN", # See 'Ｄａｒｋ  Ｌａｄｙ'
    509: "UNKNOWN", # See 'Ｗｈｉｔｅ  Ｌｅｇｅｎｄ'
}
...
if __name__ == '__main__':
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C69ROM1.txt', 'rb') as file:
        lines = file.readlines()
    with open(Path(__file__).parent / 'CDATA' / 'C69ROM2.txt', 'rb') as file:
    ...
    # ===== Load csv like data ======
    with open(Path(__file__).parent / 'CDATA' / 'C69ROM0.txt', 'rb') as file:
        lines = file.readlines()
