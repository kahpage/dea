...
const PATH_DB_TO_EXPORT =  _is_prod ? `https://raw.githubusercontent.com/kahpage/dea_db/refs/heads/master/databases_to_export` : `/dea/dea_db/databases_to_export`; // Path of raw databases (media)
